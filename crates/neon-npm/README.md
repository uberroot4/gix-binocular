...
Building neon-npm requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
After building neon-npm, you can explore its exports at the Node console:
